...
# TODO: these break the saml_session JSONSerialiser
...
SAML_CONFIG = {
    ...
    # remote metadata
    "metadata": {
        "local": [os.path.join(SAML_CONFIG_DIR, "idp_metadata.xml")],
    },
}
...
SAML_IDP_SERVICE_PROVIDER_MODEL = "samlidp.ServiceProvider"
