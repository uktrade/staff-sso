...
SAML_CONFIG_DIR = os.path.join(BASE_DIR, "config", "saml", ENV_NAME)
...
SAML_CONFIG = {
    ...
    # remote metadata
    "metadata": {"local": [os.path.join(SAML_CONFIG_DIR, "idp_metadata.xml")],},
}
...
LOGGING = {
    ...
    "loggers": {
        "x-auth": {"handlers": ["console"], "level": "INFO", "propagate": False,},
        "djangosaml2": {"handlers": ["console"], "level": "INFO", "propagate": False,},
    },
}
...
SAML_IDP_CONFIG_DIR = os.path.join(BASE_DIR, "config", "saml-idp", ENV_NAME,)
...
SAML_IDP_CONFIG = {
    ...
    # Encryption
    "encryption_keypairs": [
        {"key_file": SAML_IDP_PRIVATE_KEY_PATH, "cert_file": SAML_IDP_PUBLIC_CERT_PATH,}
    ],
    "valid_for": 365 * 24,
}
...
SAML_IDP_SPCONFIG = {
    "aws-quicksight": {
        ...
        "attribute_mapping": {},
        "extra_config": {"role": SAML2_QUICKSIGHT_AWS_ROLE_ARN,},
    },
    "aws-appstream": {
        "entity_id": "urn:amazon:webservices",
        "processor": "sso.samlidp.processors.AWSProcessor",
        "attribute_mapping": {},
        "extra_config": {"role": SAML2_APPSTREAM_AWS_ROLE_ARN,},
    },
    "google.com": {
