...
# NOTE: these vars are temporary and will be removed
NEW_AUTH_FLOW_EMAILS=env.list('NEW_AUTH_FLOW_EMAILS')
NEW_AUTH_FLOW_WEIGHTING_PERCENT=env.int('NEW_AUTH_FLOW_WEIGHTING_PERCENT', 10)
NEW_AUTH_FLOW_CHOICE_INDEX=env.int('NEW_AUTH_FLOW_CHOICE_INDEX', 1)
