            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        validators=[oauth2_provider.validators.RedirectURIValidator],
                    ),
                ),
                (
                    "client_type",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Allow all authenticated users to access this application",
                        verbose_name="default access allowed",
                    ),
                ),
                (
                    "user",
