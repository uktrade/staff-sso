# Generated by Django 3.1.5 on 2021-03-05 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='unique text id')),
                ...
                ('allow_access_by_email_suffix', models.CharField(blank=True, help_text='A comma separated list of email domains, e.g. "mobile.ukti.gov.uk, trade.gsi.gov.uk, fco.gov.uk" User\'s with an email in this list will be given access.  NOTE: all user emails are checked - including aliases.', max_length=255, null=True, verbose_name='allow access by email')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['entity_id'], name='samlidp_ser_entity__6f24fa_idx'),
        ),
    ]
