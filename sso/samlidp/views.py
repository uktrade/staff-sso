...
from djangosaml2idp.views import IdPHandlerViewMixin, LoginProcessView, SSOInitView
...
#             resp_args["name_id_policy"].format
#             if resp_args["name_id_policy"]
#             else settings.SAML_IDP_CONFIG["service"]["idp"]["name_id_format"][0]
#         )
#
#         try:
...
#                 request,
#                 exception=ImproperlyConfigured(
#                     "No config for SP %s defined in SAML_IDP_SPCONFIG" % sp_entity_id
#                 ),
#                 status=400,
#             )
#
